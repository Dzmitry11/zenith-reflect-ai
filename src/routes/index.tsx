        ...
        <section className="max-w-5xl mx-auto px-6 py-16">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              <div key={f.title} className="rounded-2xl bg-card/60 backdrop-blur-md border border-border/50 p-6 space-y-3 hover:bg-card/80 transition-all">
        ...
        <section className="max-w-3xl mx-auto px-6 py-16">
          ...
          <div className="space-y-6">
            {[
              ...
              <div key={s.step} className="flex gap-4 p-4 rounded-xl bg-card/50 backdrop-blur-sm border border-border/30">
