...
function LandingPage() {
  return (
    <div className="min-h-screen relative">
      {/* Background */}
      <div className="fixed inset-0 z-0 bg-cover bg-center bg-no-repeat" style={{ backgroundImage: `url(${bgLanding})` }} />
      <div className="fixed inset-0 z-0 bg-background/70 backdrop-blur-[2px]" />
      ...
      <div className="relative z-10">
        ...
        <ScaleIn>
          <section className="max-w-3xl mx-auto px-6 py-8">
            <div className="rounded-2xl bg-card/70 backdrop-blur-md border border-border/50 p-6 text-center">
          ...
          <StaggerContainer className="grid md:grid-cols-3 gap-6">
            {[
              ...
              <StaggerItem key={f.title}>
                <div className="rounded-2xl bg-card/60 backdrop-blur-md border border-border/50 p-6 space-y-3 hover:bg-card/80 transition-all">
        ...
        <section className="max-w-3xl mx-auto px-6 py-16">
          ...
          <div className="space-y-6">
            {[
              ...
              <FadeIn key={s.step} delay={i * 0.12} direction="left">
                <div className="flex gap-4 p-4 rounded-xl bg-card/50 backdrop-blur-sm border border-border/30">
        ...
        <section className="max-w-3xl mx-auto px-6 py-16">
          ...
          <StaggerContainer className="grid md:grid-cols-2 gap-4" stagger={0.15}>
            <StaggerItem>
              <div className="rounded-2xl bg-card/60 backdrop-blur-md border border-border/50 p-6">
            ...
            <StaggerItem>
              <div className="rounded-2xl border-2 border-primary/20 bg-gradient-to-br from-primary/5 to-calm/10 backdrop-blur-md p-6">
        ...
        <FadeIn direction="none">
          <footer className="border-t border-border/30 py-8 px-6 bg-card/30 backdrop-blur-sm">
