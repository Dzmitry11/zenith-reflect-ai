  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 cursor-pointer",
  {
    variants: {
      variant: {
        ...
        hero: "bg-primary text-primary-foreground shadow-md hover:shadow-lg hover:bg-primary/90 active:scale-[0.97] text-base",
        warm: "bg-warm text-warm-foreground hover:bg-warm/80 border border-warm/50",
        calm: "bg-calm text-calm-foreground hover:bg-calm/80 border border-calm/50",
        soft: "bg-soft text-soft-foreground hover:bg-soft/80 border border-soft/50",
      },
      size: {
